...
<body>
	...
	%>
	<%
	String muaxong = (String) request.getAttribute("muaxong");
	if (muaxong != null) {
	%>
	<script>
 ...
 %>
					...
					<div class="col">
						<div class="main_slider_content">
							...
							<div class="red_button shop_now_button">
								<a href="sanphamController">mua ngay</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="best_sellers">
			<div class="container">
				...
				<div class="row">
					<div class="col">
						<div class="product_slider_container" style="height: 400px">
							<div class="owl-carousel owl-theme product_slider">
								...
								<div class="owl-item product_slider_item">
									<div class="product-item">
										...
										<div class="red_button add_to_cart_button">
											<a
												href="GioController?msp=<%=ss.getMasanpham()%>&tsp=<%=ss.getTensanpham()%>&gia=<%=ss.getGia()%>&anh=<%=ss.getAnh()%>&mau=<%=ss.getMau()%>">Thêm
												vào giỏ</a>
										</div>
									</div>
								</div>
