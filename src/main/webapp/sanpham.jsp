...
<link rel="stylesheet" type="text/css" href="styles/sanpham.css" />
<link rel="stylesheet" type="text/css"
			...
			<div class="row">
				<div class="col product_section clearfix">
					...
					<div class="breadcrumbs d-flex flex-row align-items-center">
						<ul>
							<li><a href="trangchuController">Trang chủ</a></li>
							<li class="active"><a href="sanphamController"><i
									class="fa fa-angle-right" aria-hidden="true"></i>Sản phẩm</a></li>
						</ul>
					</div>
					...
					<div class="sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								for (loaibean loai : t) {
								%>
								<li><a href="sanphamController?ml=<%=loai.getMaloai()%>"><%=loai.getTenloai()%></a></li>
								<%
								}
								%>
							</ul>
									...
									<div class="product-grid">
										...
										<div
											...
											<div class="product discount product_filter">
												...
												<div class="product_info">
													<h6 class="product_name">
														<a
															href="chitietsanphamController?masp=<%=s.getMasanpham()%>"><%=s.getTensanpham()%></a>
													</h6>
											...
											<div class="red_button add_to_cart_button">
												<a
													href="GioController?msp=<%=s.getMasanpham()%>&tsp=<%=s.getTensanpham()%>&gia=<%=s.getGia()%>&anh=<%=s.getAnh()%>&mau=<%=s.getMau()%>">Thêm
													vào giỏ</a>
											</div>
										</div>
										<%
